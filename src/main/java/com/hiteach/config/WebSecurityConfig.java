...
//            .addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class)
                ...
                .antMatchers("/api/userteacher/**").hasAnyAuthority(Contains.ROLE_USER, Contains.ROLE_TEACHER)
                .antMatchers("/api/all/**").hasAnyAuthority(Contains.ROLE_ADMIN, Contains.ROLE_TEACHER, Contains.ROLE_USER)
